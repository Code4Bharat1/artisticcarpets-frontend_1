...
export default function RegisterForm() {
  ...
  return (
    <div className="relative w-full lg:w-1/2 min-h-full bg-[#fbf4f4] flex flex-col justify-center px-5 sm:px-10 lg:px-14 py-8 sm:py-12">
      <div className="max-w-[420px] w-full mx-auto space-y-5 sm:space-y-6">
        {/* Title Header */}
        ...
        {/* Registration Form */}
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5 sm:space-y-4 w-full" noValidate>
          {/* Full Name Field */}
          <div className="space-y-1 w-full">
            ...
            <input
              ...
              {...register("name")}
              className={`w-full px-4 py-2.5 sm:py-3 text-sm font-sans text-[#1E1E1E] bg-[#faf9f5] border rounded-xl outline-none transition-all duration-200 placeholder:text-[#999999] ${
                errors.name
          ...
          <div className="space-y-1 w-full">
            ...
            <input
              id="email"
              type="email"
              placeholder="alexander@carpets.com"
              suppressHydrationWarning
              {...register("email")}
              className={`w-full px-4 py-2.5 sm:py-3 text-sm font-sans text-[#1E1E1E] bg-[#faf9f5]  border rounded-xl outline-none transition-all duration-200 placeholder:text-[#999999] ${
                errors.email
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-[#700B08] hover:bg-[#980E0A] text-white font-sans text-xs font-bold uppercase tracking-widest rounded-xl transition-all duration-300 shadow-md hover:shadow-lg cursor-pointer disabled:opacity-50 mt-1"
          >
        ...
        <div className="relative flex items-center justify-center pt-1 w-full">
          ...
          <span className="bg-[#FEF7E4] px-4 font-sans text-[10px] font-bold tracking-widest text-[#999999] uppercase shrink-0">
            OR REGISTER WITH
          </span>
          <div className="border-t border-[#E8E3DD] w-full" />
        </div>
        ...
        <div className="text-center font-sans text-xs text-[#666666] pt-1">
          ...
          <Link href="/login" className="font-semibold text-[#980E0A] hover:underline">
            Sign In
          </Link>
        </div>
      </div>
