...
import RegisterLeftHero from "./RegisterLeftHero";
  ...
  return (
    <section className="w-full py-6 sm:py-8 md:py-12 flex-1 flex flex-col justify-center">
      <Container>
        ...
        {/* Register Card */}
        <div className="bg-white rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl border border-[#E8E3DD]/60 flex flex-col lg:flex-row min-h-0 lg:min-h-[580px]">
          {/* Left 50% Editorial Loom Hero Panel */}
          <RegisterLeftHero />

          {/* Right 50% Luxury Beige Register Form */}
          <RegisterForm />
        </div>
      </Container>
    </section>
